  var config = {
  apiKey: "AIzaSyD9uNYUegl67mjKMkTN-33_14YTh0druHQ",
  authDomain: "customerinfo-692b2.firebaseapp.com",
  projectId: "customerinfo-692b2",
  storageBucket: "customerinfo-692b2.appspot.com",
  messagingSenderId: "465513228962",
  appId: "1:465513228962:web:6f4957d73ff0ff856f85fb",
  measurementId: "G-60WG2HRS0C"
  };
...
function login(){
  //console.log("login clicked");
   ...
   firebase.auth().signInWithEmailAndPassword(userEmail, userPass).then(function(user){
     ...
     window.location.href = "shipmentlist.html";
